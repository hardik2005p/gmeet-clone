...
1. Step 1 : Clone the Repository and make sure to create and add the      following in your .env file ---> 
MONGODB_URL=<your mongodb url>


2. Step 2 : Run npm install for dependencies.
3. Step 3 : Run node main.js
4. Step 4 : Go to cd frontend.
5. Step 5 : Run     